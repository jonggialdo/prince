					...
					<div class="row">
						<div class="col-lg-3 thumbnails_col order-lg-1 order-2">
							<div class="single_product_thumbnails">
								<ul>
									<li><img src="{{asset('images/'.$product->photo_product)}}" alt="" data-image="assets/images/single_1.jpg"></li>
									<li class="active"><img src="{{asset('images/'.$product->photo_product)}}" alt="" data-image="assets/images/single_2.jpg"></li>
									<li><img src="{{asset('images/'.$product->photo_product)}}" alt="" data-image="assets/images/single_3.jpg"></li>
								</ul>
							</div>
						</div>
