...
<link rel="stylesheet" type="text/css" href="{{asset('assets/tyles/bootstrap4/bootstrap.min.css')}}">
...
<link rel="stylesheet" type="text/css" href="{{asset('assets/tyles/contact_styles.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('assets/tyles/contact_responsive.css')}}">
</head>
