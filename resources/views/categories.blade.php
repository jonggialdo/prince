...
<link rel="stylesheet" type="text/css" href="{{asset('assets/tyles/bootstrap4/bootstrap.min.cs')}}s">
...
<link rel="stylesheet" type="text/css" href="{{asset('assets/tyles/categories_styles.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('assets/tyles/categories_responsive.css')}}">
</head>
...
<script src="{{asset('assets/tyles/bootstrap4/popper.js"></script>
<script src="{{asset('assets/tyles/bootstrap4/bootstrap.min.js"></script>
<script src="{{asset('assets/plugins/Isotope/isotope.pkgd.min.js"></script>
<script src="{{asset('assets/plugins/OwlCarousel2-2.2.1/owl.carousel.js"></script>
<script src="{{asset('assets/plugins/easing/easing.js"></script>
<script src="{{asset('assets/plugins/jquery-ui-1.12.1.custom/jquery-ui.js"></script>
<script src="{{asset('assets/categories_custom.js"></script>
</body>
