...
<link rel="stylesheet" type="text/css" href="{{asset('assets/tyles/single_styles.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('assets/tyles/single_responsive.css')}}">
</head>
